...
<body>
 <?php include('student_menu.php'); if(isset($_SESSION['email'])){;?> 
  <table id="tb">
    <tr>
     ...
     <?php
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
                ...
                echo "<td><a target='_self' class='btn btn-secondary' aria-current='page' href='job_details.php?c_id=".$row['c_id']."'>Available Jobs</a></td>";
            echo "</tr>";
        }
        echo "</tr></table><div style='margin-bottom:30%;'></div>";
        include('footer.php');
      }
      else
