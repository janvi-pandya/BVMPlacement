...
require "PHPMailerAutoload.php";
	...
	//	print_r($_SESSION);
		...
		//echo $p['user_id'];
				...
				$sql="select `name` from `tpc_member` where `email`='$email';";
				...
				$body="<center><b>Welcome $name ! It's great to have you on board! <br/>You are now successfully connected to our Placementsite!<br/><br/>You are now granted access to manage Recruiting Companies and Placement Applicant Students</b></center>
